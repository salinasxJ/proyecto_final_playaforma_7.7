...
<button onclick="agregarCarrito('Camiseta Negra',50000)" class="boton-agregar">
...
<button onclick="agregarCarrito('Hoodie Blanca',90000)" class="boton-agregar">
<i class="fa-solid fa-cart-plus"></i> Agregar
</button>
...
<button onclick="agregarCarrito('Gorra Urbana',35000)" class="boton-agregar">
<i class="fa-solid fa-cart-plus"></i> Agregar
</button>
